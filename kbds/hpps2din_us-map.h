 ...
 *
 * HP PS2_DIN keyboard (US Version) default map
 * Generated by Michael Piotrowski <mxp@linguistik.uni-erlangen.de> on a
 * B132L running HP-UX 10.20
*/

static const struct default_keycode_map hpps2din_us_map [] = {
  {  16, 0,		{ XK_F1 }},
  {  17, 0,		{ XK_Escape }},
  ...
  {  62, 0,		{ XK_y,	XK_Y,
			  XK_usldead_asciicircum,	XK_usldead_asciicircum }},
  ...
  {  75, 0,		{ XK_k,	XK_K,
			  XK_cent,	XK_cent }},
  {  76, 0,		{ XK_i,	XK_I,
			  XK_usldead_asciitilde,	XK_usldead_asciitilde }},
  {  77, 0,		{ XK_o,	XK_O,
  ...
  { 122, 0,		{ XK_KP_Decimal,	XK_KP_Delete }},
