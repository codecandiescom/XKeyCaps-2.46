 ...
 *
 * This file describes the default keymap of the Sun 101-A keyboard
 * as interpreted by X Consortium R4 and R5 servers.  Generated by 
 * Christopher Davis <ckd@kei.com>.
 *
 * This map is very nearly identical to sun5-xc-map.h (the modifiers
 * are different on a few keys.)  I can't begin to explain why this is
 * any different, since the R5 server has no knowledge of the 101A.  
 * ckd used X11R5p26 on SunOS 4.1.2 with gcc 2.4.5.
 */


static const struct default_keycode_map sun101a_xc_map [] = {
