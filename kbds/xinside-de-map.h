 ...
 *
 * This file describes the keymap of a "Cherry" 102 key PC-style keyboard
 * on Linux 2.0 running the "Accelerated X" server from X Inside Inc.
 * By "D.Stolte" <d.stolte@tu-bs.de>
 */

static const struct default_keycode_map xinside_de_map [] = {
  {   9, 0,		{ XK_Escape }},
  {  10, 0,		{ XK_1,	XK_exclam }},
