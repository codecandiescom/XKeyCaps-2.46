 ...
 *
 * This file describes the keycodes of a generic 101 key Dell keyboard
 * on BSDI running the "Accelerated X" server from X Inside Inc.
 * By Joe Siegrist <iniquity@cs.UMD.EDU>.
 */

static const KeyCode pc101_codes [] = {
  /* Row 0 */
  9,
  67, 68, 69, 70,
  71, 72, 73, 74,
