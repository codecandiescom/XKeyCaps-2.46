 ...
 * Alon Albert <al@mercury.co.il> using build-map.sh
 */

static const struct default_keycode_map sun5pc_xc6_map [] = {
  {   8, 0,		{ XK_Cancel,	0,
			XK_F11 }},
