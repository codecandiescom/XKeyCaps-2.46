 ...
 *
 * This file describes the default US keymap used by the XFree86 X server.
 * Created by jwz against XFree86 3.3.2 on 20-Jun-99.
 */

static const struct default_keycode_map xfree86us_map [] = {
  {   9, 0,		{ XK_Escape }},
  {  10, 0,		{ XK_1,	XK_exclam }},
  {  11, 0,		{ XK_2,	XK_at }},
