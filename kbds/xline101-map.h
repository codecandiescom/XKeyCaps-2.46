 ...
 *
 * This file describes the keymap of a US 101-key PC keyboard
 * attached to a Pericom X-Line X server.
 * By Ben Harris <bjh21@cam.ac.uk>
 */

static const struct default_keycode_map xline101_map [] = {
  ...
  {  21, 0,		{ XK_BackSpace,	XK_BackSpace }},
  {  22, 0,		{ XK_Tab,	XK_Tab }},
  {  23, 0,		{ XK_q,	XK_Q }},
  {  24, 0,		{ XK_w,	XK_W }},
  {  25, 0,		{ XK_e,	XK_E }},
