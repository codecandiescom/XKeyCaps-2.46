...
static const struct key_geometry sun5_geom_row0 [] = {
 {14, 7}, {4, 0},
 {7, 7}, {7, 0},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}, {3, 0},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}, {4, 0},
...
static const struct key_geometry sun5_geom_row1 [] = {
 {7, 7}, {7, 7}, {4, 0},
...
static const struct key_geometry sun5pc_geom_row1 [] = {
 {7, 7}, {7, 7}, {4, 0},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7},
...
static const struct key_geometry sun5_geom_row2 [] = {
 {7, 7}, {7, 7}, {4, 0},
...
static const struct key_geometry sun5_geom_row3 [] = {
 {7, 7}, {7, 7}, {4, 0},
...
static const struct key_geometry sun5_geom_row4 [] = {
 {7, 7}, {7, 7}, {4, 0},
...
static const struct key_geometry sun5_geom_row5 [] = {
 {7, 7}, {7, 7}, {4, 0},
...
static const struct key_geometry sun5pc_geom_row5 [] = {
 {7, 7}, {7, 7}, {4, 0},
...
static const struct keyboard_row_geometry sun5_geom_rows [] = {
...
static const struct keyboard_row_geometry sun5pc_geom_rows [] = {
  ROW (sun5_geom_row0, 7),
  EMPTYROW (7),
...
static const struct keyboard_geometry sun5_geom = {
  sizeof (sun5_geom_rows) / sizeof (struct keyboard_row_geometry),
  sun5_geom_rows, 6, 3, 3
};

static const struct keyboard_geometry sun5pc_geom = {
