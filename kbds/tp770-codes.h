 ...
 *
 * This file describes the keycodes of the IBM ThinkPad 770Z keyboard
 * under XFree86 3.3.3 on Linux 2.2.7.
 * By Paul Phillips <paulp@go2net.com>
 *
 * Note: The "Fn" key apparently doesn't deliver events to the X server.
 */

static const KeyCode tp770_codes [] = {
 /* Row 0 */
  9,
