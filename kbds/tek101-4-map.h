 ...
 *
 * This file describes the default keymap of the Tektronix XP20 keyboard,
 *_TEK_KEYBOARD_TYPE = "ibm101" (101-key North American Keyboard)
 * for X11R4.  By Joe English <joe@trystero.art.com>.
 *
 * The default keymap changed between R4 and R5.  The R4 bindings should work
 * on an R5 server, but the reverse does not hold: as of release 5, the
 * TekSetup function is invoked by any key bound to the (new) TekXK_Setup
 * keysym, whereas before it was invoked by a specific keycode.
 */

static const struct default_keycode_map tek101_4_map [] = {
  {  15, 0,		{ XK_F1 }},
  {  16, 0,		{ XK_Escape }},
  {  21, 0,		{ XK_Tab }},
