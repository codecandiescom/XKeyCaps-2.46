 ...
 *
 * This file describes the keymap of a Microsoft `Natural' 105 key
 * keyboard, US layout, on Linux with Xfree86 3.1.1 (X11R6)
 * Generated by Matthias Rabe <rabe@mathematik.uni-bielefeld.de>.
 */

static const struct default_keycode_map ms105_linux_map [] = {
  {   9, 0,		{ XK_Escape }},
  {  10, 0,		{ XK_1,	XK_exclam }},
  {  11, 0,		{ XK_2,	XK_at }},
