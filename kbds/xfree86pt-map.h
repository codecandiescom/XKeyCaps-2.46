 ...
 *
 * This file describes the default PT keymap used by the XFree86 X server.
 * By Jan Wedekind <jan@todonix.ruhr.de>
 */

static const struct default_keycode_map xfree86pt_map [] = {
  {   9, 0,		{ XK_Escape }},
  {  10, 0,		{ XK_1,	XK_exclam,
  ...
  {  21, 0,		{ XK_guillemotleft,	XK_guillemotright,
  ...
  {  33, 0,		{ XK_p,	XK_P,
			  XK_thorn,	XK_THORN }},
  {  34, 0,		{ XK_plus,	XK_asterisk,
			  XK_dead_diaeresis,	XK_dead_abovering }},
  {  35, 0,		{ XK_dead_acute,	XK_dead_grave,
