/* xkeycaps, Copyright (c) 1993 Jamie Zawinski <jwz@jwz.org>
 *
 * This file describes the default keymap of the Sun type 5 PC-style keyboard
 * when running the XNews DE OW 3.0 server.
 * By Sylvain Meunier <meunier@inf.enst.fr>.
 */

static const struct default_keycode_map sun5pc_owde_map [] = {
